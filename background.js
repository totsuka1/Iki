...
//   chrome.notifications.create("Iki Reminder", {
//     type: "basic",
//     title: "Iki Reminder",
//     message: "It's been a while, take a breather!",
//     priority: 2,
//   });
// }
...
//     { sound: true, delay: 2, badge: false },
//     function (data) {
//       sound = data.sound;
//       delay = data.delay;
//       badge = data.badge;
...
//           delayInMinutes: data.interval,
//           periodInMinutes: data.interval,
//           when: alert.scheduledTime,
//         });
//       });
//     }
//   );
...
function play() {
  if (sound === null) {
    chrome.storage.local.get(
      { sound: true, delay: 20, badge: false },
      function (data) {
        sound = data.sound;
        delay = data.delay;
        badge = data.badge;
